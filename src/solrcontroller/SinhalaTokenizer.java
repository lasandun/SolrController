...
public class SinhalaTokenizer {
    ...
    public final String invalidChars[] = {"Ê",
                                    "\u00a0", "\u2003", // spaces
    ...
    public final String wordTokenizerDelims;
    
    public final String lineTokenizingChars[] = {".", "?", "!", ":", ";", "\u2022"};
    
    public final String punctuationsWithoutLineTokenizingChars[] = {",", "¸", "‚",
                                                                    "\"", "/", "-", "\\|", "\\\\", "—", "¦",
                                                                    "”", "‘", "'", "“", "’", "´", "´",
                                                                    "!", "@", "#", "\\$", "\\%", "\\^", "\\&", 
                                                                    "\\*", "\\+", "\\-", "£", "\\?", "˜",
